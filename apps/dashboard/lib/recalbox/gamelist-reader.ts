 ...
 */
export async function readGamelist(gamelistPath: string, ssh: SshClientLike): Promise<string | null> {
 ...
 */
export async function readUserdataIni(romsBasePath: string, ssh: SshClientLike): Promise<string | null> {
